//! Host-side dequantization: GGUF quant/float tensors -> f32, plus f16 byte packing.
...
pub(crate) fn dequant_block(dtype: infr_core::DType, bytes: &[u8]) -> Result<Vec<f32>> {
    use infr_core::DType::*;
    Ok(match dtype {
...
pub(crate) fn f32_to_f16_sat(x: f32) -> half::f16 {
...
pub(crate) fn rdf16(b: &[u8]) -> f32 {
    half::f16::from_le_bytes([b[0], b[1]]).to_f32()
}
pub(crate) fn k4(j: usize, q: &[u8]) -> (u32, u32) {
...
pub(crate) const IQ1S_DELTA: f32 = 0.125;
...
pub(crate) fn is_codebook_quant(d: infr_core::DType) -> bool {
    use infr_core::DType::*;
    matches!(
        d,
        Iq1S | Iq1M
...
pub(crate) fn dequant_codebook(dtype: infr_core::DType, bytes: &[u8]) -> Vec<f32> {
    use infr_core::DType::*;
    match dtype {
...
pub(crate) fn is_quant(d: infr_core::DType) -> bool {
    use infr_core::DType::*;
    matches!(
        d,
